...
/**
 * Base class for typesetting drivers.
 * @abstract
 * @class
 */
class OutputDevice {
	...
	exec(cmd, data){
		switch(cmd){
			...
			case CC0: this.printCharByName(data); break;
			...
			case MM0:
				this.setColour(data[0], data.substr(1).split(/\s+/));
				break;
			
			case NN0:
				this.printCharByIndex(String.fromCharCode(+data));
				break;

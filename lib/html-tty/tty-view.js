...
const PageReference = require("../man/page-reference.js");
 ...
 *
 * @class
 * @property {PageReference} currentPage
 *    Read-only reference to the currently-rendered page.
 *
 * @property {LoadState} [loadState=0]
 *    An unsigned integer that indicates whether a page loaded,
 *    is still loading, or failed to load. For a description of
 *    each constant, see {@link PageLoader.LoadState}.
 *
 * @property {Map} landmarks
 *    Heading-like elements mapped by their `textContent` property.
 *    Used for scrolling to specific subsections when deep-linking.
 *    See {@link #remapLandmarks}.
 */
class TTYView{
	
	/**
	 * Instantiate a new TTYView instance.
	 *
	 * @constructor
	 * @param {Object} [attr={}]
	 ...
	 *                new TTYView({ parentElement: document.body });
	 *
	 *       @example <caption>Creating first, attaching later</caption>
	 *                let view = new TTYView();
	 ...
	 *    view.handleClick !== TTYView.prototype.handleClick;
	 *

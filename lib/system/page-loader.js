 ...
 * Handles the bulk of interaction between the running Node process,
 * and the system's troff(1) and man(1) executables. Most authors
 * will only need one (globally shareable) instance of this class.
 * @class
 */
class PageLoader{
	 ...
	 * @param {String} [format="ps"]
	 * @public
	 */
	async load(topic, section = "", format = "ps"){

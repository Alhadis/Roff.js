...
const fontStyles    = require("../tables/font-styles.json");
const symbolMaps    = require("../tables/symbol-maps.json");
const {tokenTypes}  = Postprocessor;


class TroffCanvasRenderer extends Postprocessor{
...
module.exports = TroffCanvasRenderer;

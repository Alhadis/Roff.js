...
const TroffCanvasRenderer = require("./renderer.js");
...
class TroffCanvasViewer{
	...
	loadFile(path){
		...
		.catch(error => {
			console.error(`[TroffCanvasView::loadFile] Error loading ${path}`);
			console.dir(error);
		});
	}
...
Object.assign(TroffCanvasView.prototype, {
	classNames: {
		root:        "troff-view",
...
module.exports = TroffCanvasView;

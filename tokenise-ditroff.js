...
const SS0 = -5; // Switch: `s` command
const FF0 = -6; // Switch: `f` command
const CC0 = -7; // Switch: `c` command
...
╠═════════════╬═══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╣
║ Start   ___ ║*/[ ___, ___, ___, ___, ___, CO0, ___, ___, ___, ___, ___, ___, ___, ___, ___, CC0, ___, FF0, ___, ___, ___, PP0, SS0, ___, ___, ___, ___, XX0 ],/*
